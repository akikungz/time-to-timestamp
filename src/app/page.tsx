...
export default function Home() {
  ...
  const optStartTime = useMemo(() => getSeconds(startTime), [startTime]);
  ...
  }, [inputTemp, inputCount, optStartTime]);
      ...
      <div className="gap-2 flex flex-col justify-center items-center p-4 max-w-lg w-full">
        ...
        <div className="flex flex-col gap-2 justify-center items-start w-full">
          ...
          <div className="flex flex-row justify-center items-center gap-2 w-full">
            ...
            />
            <span>{optStartTime !== undefined ? "✅" : "❌"}</span>
          </div>
        </div>
        ...
        <div className="flex flex-row justify-center items-center gap-2 w-full">
          ...
          <button
            className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded w-full"
            onClick={() =>
              loadHandler(setInputTemp, setInputCount, setStartTime)
            }
          >
            Load
          </button>
